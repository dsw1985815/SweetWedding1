...
const picListDetails = db.collection('picListDetails')
...
goToAdd: function () {
  wx.navigateTo({
    url: '../add/add?typename='+this.data.typename,
  })
 ...
 * 自定义函数--跳转上传图片页add
 */
goToAddCaver: function () {
  wx.navigateTo({
    url: '../addcover/addcover?typename='+this.data.typename+'&coverurl='+this.data.coverurl,
  })
